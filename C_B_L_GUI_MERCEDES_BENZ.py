# This a GUI for testing Mercedes CAN-BUS with BOSCH ME9.7 ECU for
#Monitoring both of packets(Normal, Diagnostics)
...
class Real_CAN_Bus_Monitor:
    def __init__(self, top=None):
        ...
        top.title("BenzS500 Real CAN Bus Monitor")
        ...
        self.Label4.configure(text='''Throttle:''')
        ...
        self.Label6.configure(text='''rpm:''')
        ...
        self.Message2.configure(text="Throttle")
        ...
        self.Message5.configure(text="rpm")
        ...
        self.DiagnosticBtn.configure(text='''Diagnostic BENZ ''')
    ...
    def diagnosticData(self):
        ...
        while self.isRunningDiagnosticThread:
            ...
            elif message.arbitration_id == PID_REPLY and message.data[2] == ENGINE_RPM:
                rpm = round(((message.data[3]*256) + message.data[4])/4)

            elif message.arbitration_id == PID_REPLY and message.data[2] == THROTTLE:
                throttle = round((message.data[3]*100)/255)
	    				
##            if message.arbitration_id == PID_REPLY  and message.dlc==8 and message.data[0]==ENGINE_COOLANT_TEMP:                    
